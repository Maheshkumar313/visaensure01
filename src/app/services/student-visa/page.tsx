      ...
      <main className="flex-1 py-12 md:py-16 relative">
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8 space-y-12 relative z-10">
          ...
          <div className="pt-2">
            <Link 
              href="/"
              className="inline-flex items-center gap-2 text-sm font-medium text-gray-600 hover:text-orange-600 transition-colors group"
            >
              <div className="p-2 rounded-full bg-white shadow-sm border border-gray-200 group-hover:border-orange-600/30 group-hover:bg-orange-600/5 transition-all duration-300">
          ...
          <div className="space-y-6 text-center max-w-4xl mx-auto mt-4">
            <span className="text-xs font-bold tracking-widest text-orange-600 uppercase bg-gradient-to-r from-orange-50 to-orange-100/50 border border-orange-200/50 px-4 py-1.5 rounded-full inline-block shadow-sm">
          ...
          <section className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-6">
            {[
              ...
              <div key={idx} className="bg-white border border-gray-200 shadow-sm p-8 rounded-3xl space-y-4 hover:shadow-md hover:-translate-y-1 hover:border-orange-600/30 transition-all duration-300 group">
                <div className="w-12 h-12 bg-gray-50 group-hover:bg-orange-600/10 border border-gray-100 group-hover:border-orange-600/20 rounded-2xl flex items-center justify-center transition-colors duration-300">
                  {item.icon}
                </div>
