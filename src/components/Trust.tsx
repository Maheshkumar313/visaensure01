...
export default function Trust() {
  return (
    <section id="about" className="py-20 bg-[#050b14] border-t border-white/5 relative">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-stretch">
          ...
          >
            ...
            <div className="pt-6 border-t border-white/5 mt-6 flex items-center justify-between text-xs">
              ...
              <strong className="text-white">4.9 / 5.0 (Excellent)</strong>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="space-y-4">
              ...
              <div className="relative border border-white/10 rounded-xl p-3 bg-[#0A1628]/85 overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-b from-transparent to-[#0A1628]/95 z-10 pointer-events-none" />
                <div className="absolute top-2 right-2 bg-green-500 text-[#0A1628] text-[9px] font-extrabold tracking-wider px-2 py-0.5 rounded-full z-20 uppercase animate-pulse">
                  APPROVED
                </div>
                
                {/* Mock data lines */}
                <div className="space-y-1.5 filter blur-[1px] group-hover:blur-none transition-all duration-500 text-[10px] text-gray-400 font-mono">
            ...
            <div className="pt-6 border-t border-white/5 mt-6 flex items-center justify-between text-xs relative z-20">
              <span className="text-gray-400">DATA PROTECTION</span>
              <strong className="text-white">GDPR Compliant</strong>
            </div>
          </motion.div>
