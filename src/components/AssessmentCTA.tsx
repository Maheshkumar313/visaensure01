      ...
      <div className="max-w-6xl mx-auto px-4 md:px-8 relative z-10">
        ...
        <div className="w-full bg-gradient-to-r from-[#122540] to-[#0A1628] border border-orange/25 rounded-3xl p-8 md:p-12 flex flex-col md:flex-row items-center justify-between gap-8 relative overflow-hidden shadow-2xl">
          ...
          <button
            ...
            className="px-8 py-4 bg-[#EA580C] hover:bg-[#F97316] text-[#0A1628] font-bold rounded-full transition-all duration-300 hover:scale-105 shadow-lg hover:shadow-gold/20 flex items-center justify-center gap-2 cursor-pointer shrink-0"
          >
