...
export default function ServicePageClient({ service }: ServicePageClientProps) {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#0A1628] text-white overflow-hidden">
      <TopBar />

      {/* Breadcrumb / Nav */}
      <header className="border-b border-white/5 py-4 bg-[#050b14]/90 sticky top-0 z-30 backdrop-blur-md">
      ...
      <main className="flex-1 py-12 md:py-20 relative">
        ...
        <div className="max-w-4xl mx-auto px-4">
          ...
          >
            <h2 className="text-xl font-bold font-heading text-white">Overview</h2>
          ...
          <motion.section 
            ...
            className="space-y-4 mb-12 bg-white/5 border border-white/5 p-6 rounded-2xl"
          >
            <h2 className="text-xl font-bold font-heading text-white">Platform Inclusions</h2>
          ...
          <section className="space-y-4 mb-12">
            <h2 className="text-xl font-bold font-heading text-white">Eligibility Criteria & Prerequisites</h2>
            <motion.ul 
              variants={containerVariants}
              initial="hidden"
              whileInView="show"
          ...
          <section className="space-y-6 mb-12">
            <h2 className="text-xl font-bold font-heading text-white">Immigration Pipeline Pathway</h2>
          ...
          {/* Collapsible FAQs */}
          <section className="space-y-4 mb-12">
            <h2 className="text-xl font-bold font-heading text-white">Frequently Asked Questions</h2>
