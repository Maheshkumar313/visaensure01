    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 w-full relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          <motion.p
            variants={itemVariants}
            className="text-gray-300 text-sm md:text-base max-w-xl mx-auto lg:mx-0 leading-relaxed font-body"
          >
          ...
          <motion.div
            variants={itemVariants}
            className="grid grid-cols-2 sm:grid-cols-4 gap-6 pt-6 border-t border-white/10 max-w-xl mx-auto lg:mx-0"
          >
