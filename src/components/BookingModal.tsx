      ...
      <div className="relative w-full max-w-xl bg-[#0A1628] border border-gold/30 rounded-2xl overflow-hidden shadow-2xl z-10 transition-all duration-300">
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-white/10 bg-gradient-to-r from-[#050b14] to-[#0A1628]">
          <div>
            ...
            <p className="text-xs text-gray-400">Select a slot with an immigration partner</p>
          </div>
          <button
            onClick={onClose}
          ...
          {!isSubmitted ? (
            ...
            <div className="py-8 text-center space-y-6">
              ...
              <div className="space-y-2">
                <h4 className="text-2xl font-heading text-white font-bold">Booking Confirmed!</h4>
              ...
              <div className="bg-[#122540] border border-white/5 p-4 rounded-xl max-w-md mx-auto space-y-2">
              ...
              <p className="text-xs text-gray-400">
                Our premium consultant will call you at <strong className="text-white">{formData.phone}</strong>.
              </p>

              <div className="flex gap-4 max-w-xs mx-auto pt-2">
                <button
                  onClick={onClose}
                  className="flex-1 py-2.5 bg-white/10 hover:bg-white/20 text-white rounded-lg text-sm transition-all"
                >
                  Close Window
                </button>
              </div>
